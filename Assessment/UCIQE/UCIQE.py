"""
https://blog.csdn.net/robot123654/article/details/132122509
UCIQE是评价水下图像色度、饱和度和对比度的综合指标,取值范围为[0,1]。
UCIQE 的值越高,表明图像具有更好的视觉质量.
...
if __name__ == "__main__":
    # raw_path = 'D:\\dataset\\UIEB_Dataset\\challenging-10\\2.png'   # 0.4394828233719556
    # result_path = 'D:\\dataset\\UIEB_Dataset\\challenging-10-out-P4-Resize256\\result_2.png'  # 0.5347825706608291

    raw_path = 'D:\\dataset\\UIEB_Dataset\\challenging-10\\5.png'  # 0.5262843037471578
    result_path = 'D:\\dataset\\UIEB_Dataset\\challenging-10-out-P4-Resize256\\result_5.png'  # 0.5615572609280781

    d_1 = uciqe(1, raw_path)
    d_2 = uciqe(1, result_path)
    print(d_1)
    print(d_2)
